...
export const aboutContentData = {
  ...
  hero: {
    title: 'Buy Smart. Sell Wise.',
    text: 'Bright Hermosa Realty Inc. is a real estate company committed to helping individuals, families, and investors make confident and informed property decisions.',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAmid-NnETpuc4Tbi-Wx2wk0M5C9qdF5m3YZ7w3JdmlZQ_WoNBRmy7HSYuOhSYEDT0_BYBhAgl08WelLOXZcBnxcVztSby8iYTvUKx6o-rRrV7YXaclaUIaJwpIhEjFZ-v7jqDNxUtf7LUY-8EQSxLHlyBF6RJ2LFWnC902WwgU-ROq2ZuMXc-vAbAUb5cC8hQ6tCb5inAcYlTRAPJHMWufF-pqup011L8LkPg5VYkBP0wWyfx5ghDAG8R1zuXRGts9_M3RQ8dqK9w'
  },
  mission: {
    title: 'Mission',
    text: 'To guide clients toward property opportunities with clarity, integrity, and attentive service - helping them make confident decisions and create lasting value.',
    tagline: 'SERVICE / TRANSPARENCY / CONFIDENCE'
  },
  vision: {
    title: 'Vision',
    text: 'To become a trusted Philippine real estate brand known for beautiful places, responsible growth, and relationships that endure.',
    tagline: 'TRUST / GROWTH / OPPORTUNITY'
  },
  coreNarrative: {
    title: 'Our Core Narrative',
    paragraphs: [
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDpBFV3pb8_F9cqqCXeFgmHaUEJSLW2Kg4M9tm75eM_kYgwWkATnANDEACYQh5FAgttJUe0_3i_gEhHeo0wquHQDFUH6Xb2mH4IHwxkR8E33p9IFhLFclZPPzI0Q2l7ihdv0-6548kT2amowoniRfxf56fGImk67gO3iztDcxTxOnduiHt2YFRwhl5pkk07gijfQZBPRk73Vo_HjGYjNhZE987wPwoiB1TIGICOWPNJxOeWwec1_p77ICvveMkBTef8-DRIY8DWBNy5Tg'
  },
  coreCommitment: {
  ...
  offices: {
    title: 'Our Offices',
    subtitle: 'Visit us in person, our doors are always open to guide you through your next property move.',
    items: [
      {
        image: '',
  ...
  events: {
    ...
    subtitle: 'Moments from our milestones, launches, and community engagements.',
    items: [
      { image: '', imageKey: 'headOffice' },
      { image: '', imageKey: 'salesOfficeMVLC' },
      { image: '', imageKey: 'salesOfficeRTE' },
      { image: '', imageKey: 'subsidiaryOffice' },
      { image: '', imageKey: 'salesOfficeRTE' },
      { image: '', imageKey: 'salesOfficeRTE' }
    ]
  },
  coreValues: {
    title: 'Core Values',
    subtitle: 'The principles that guide our every interaction and development.',
    items: [
      {
        icon: 'verified',
        title: 'Integrity',
  ...
  whyChooseUs: {
    title: 'Why Choose Us?',
    subtitle: 'Discover the Bright Hermosa difference in every property journey.',
    reasons: [
  ...
  sustainability: {
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAud62F428PKFUZ45vS_sQ2i42V6n6OY7F2QHGdfrzwTANr-lmTsV-i00U91SvPTZksjQBKkQQDk4OupdZIjaaCfDXeff0tMhB0vXcp__Q_RGqZMZ_97MC27RWJaHRoqz0WlUIX8kvFvfRygXbv5yCgA0o3PmzW9B2EGdYIsHstrpE_uVH6x3IgUs9JKz9uv-VND8eWIMuAAsaYT7EmMWxEQqX4fSiAZudE5ZFjoOwMGO4PlFpWD-NMYksp33cFJaIirxu1vHO5ilg'
  },
  departments: {
    title: 'Company Departments',
    subtitle: 'Our specialized divisions collaborating to provide seamless land investment, legal compliance, and community development.',
    items: [
      {
        name: 'IMET',
        desc: 'IMET drives the company’s digital innovation, creative marketing, technology solutions, and online communication strategies to strengthen brand presence and support business growth.',
        image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80'
      },
      {
        name: 'Sales and Operations',
        desc: 'Sales and Operations manages client engagement, property sales, documentation, and day-to-day processes to ensure smooth transactions and excellent customer service.',
        image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80'
      },
      {
        name: 'Administration',
        desc: 'Administration supports the organization by managing office operations, employee coordination, records, resources, and internal processes to maintain an efficient workplace.',
        image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80'
      }
    ]
  }
