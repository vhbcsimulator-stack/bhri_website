export const propertiesData = [
  {
    id: "east-west-breeze",
    title: "East West Breeze Leisure Farm & Resort",
    subtitle: "Sustainable Luxury in the Heart of Indang, Cavite. A retreat where heritage meets the future of organic living.",
    heroImage: "https://lh3.googleusercontent.com/aida-public/AB6AXuDfZvQAtEyr1ePCl2ajfrR_f87QZmBrrYybGTidMEsHFjniWLZJsbXGqoJkrlnB_F8nG-F29hi680fZW8yjRvL1k_6vkwdY8N7dOGkAO_vxrJEY80-VDiYqol1Zq9Wmf4PF8z9PkiWxhLlugRcU7Jxg_ggDMu97358B9G_5Er2kJIOsZ2bLHNdZfvRmoIWq7qEczmzrN5o5yV6dtLxVUYfqrOEuo2irJznCnuQTYmx3Nns08lvc8e23P-QcyB1wsLJW3rvzpseNbnE",
    location: "Cavite",
    locationFull: "Indang, Cavite",
    badgeLocation: "INDANG CAVITE",
    badgeStatus: "PRE-SELLING",
    type: "farm", // for filtering: 'farm' (Leisure Farm Lot) or 'resort' (Resort Estate)
    typeFull: "Leisure Farm Lot",
    ...
    description: "The newest leisure farm community in the tranquil plains of Indang, Cavite within the East-West Road, providing a close proximity to Tagaytay City and Batangas province. Enjoy backyard gardening and sustainable access to fresh, organic produce in a resort-like setting.",
    iconName: "nature",
    highlightText: "Residential Farm Lots",
    intro: {
      ...
      items: [
        {
          ...
          description: "The iconic entrance is nearing completion, featuring traditional Asian-inspired wooden architecture and smart security systems.",
        ...
        },
        {
          ...
          description: "Lush perimeter buffer zones and flowering pathways are being planted to ensure privacy and natural beauty from day one.",
        ...
        },
        {
          ...
          description: "Integration of eco-friendly irrigation, retention ponds, and natural stone water details to blend beautifully with the topography.",
  ...
  {
    id: "mountain-view",
    title: "Mountain View Leisure Community",
    subtitle: "Sustainable Luxury in Munting Indang, Nasugbu, Batangas. Experience a life synchronized with nature's warm embrace.",
    ...
    location: "Batangas",
    locationFull: "Nasugbu, Batangas",
    badgeLocation: "NASUGBU BATANGAS",
    badgeStatus: "PRE-SELLING",
    type: "resort", // for filtering: 'farm' (Leisure Farm Lot) or 'resort' (Resort Estate)
    typeFull: "Resort Estate",
    cardImage: "https://lh3.googleusercontent.com/aida-public/AB6AXuDr0vEiZIAUCuUPP2o_iwBq0MpqyR09AiamTRQ_78p-sinlRmxelYE300ZRDpJJGNpi2QUi89Z0Ug1nbQ_fgSprnvqBWpQBjUUnZFvVj8JOdHUTYLpmhitXlALv2BDf5_eXRu-uEw07r8cNdcvcZ8LyhmhxzMoidQVe5rinpbd9CAn0vE9AbJxVcr6gv_e6zyfzFeKlNDsFh1pbqbWaaVXdtqewDHAEnBTcom8WUPILF7KW_GWPDXNNzRcMpJO5f9pBfwgFkwfO898",
    description: "Situated at the foothills of Nasugbu's mountains, this 30-hectare pre-selling leisure community is located in Munting Indang, Nasugbu, Batangas. It paves the way for sustainable tourism, aiming to give future lot owners a luxurious lifestyle within nature's warm embrace.",
    iconName: "landscape",
    highlightText: "Residential and Commercial",
    intro: {
      tag: "The Sanctuary",
      ...
      items: [
        {
          ...
          phase: "Phase 1",
          progress: "95% Complete",
          description: "The iconic entrance is nearing completion, featuring artisanal stone masonry and smart security systems.",
        ...
        {
          title: "Perimeter Landscaping",
          phase: "Ongoing",
          progress: "80% Complete",
          description: "Extensive green buffer zones are being planted to ensure lifelong privacy and natural biodiversity for residents.",
